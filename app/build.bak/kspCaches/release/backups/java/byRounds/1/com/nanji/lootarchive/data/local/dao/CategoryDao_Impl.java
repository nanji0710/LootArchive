  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategoryEntity = new EntityInsertionAdapter<CategoryEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`id`,`name`,`iconName`,`sortOrder`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?)";
      }
    ...
    this.__updateAdapterOfCategoryEntity = new EntityDeletionOrUpdateAdapter<CategoryEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `categories` SET `id` = ?,`name` = ?,`iconName` = ?,`sortOrder` = ?,`createdAt` = ? WHERE `id` = ?";
      }
      ...
      public List<CategoryEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new CategoryEntity(_tmpId,_tmpName,_tmpIconName,_tmpSortOrder,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public CategoryEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _result = new CategoryEntity(_tmpId,_tmpName,_tmpIconName,_tmpSortOrder,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
